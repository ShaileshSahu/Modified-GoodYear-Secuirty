            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1cd;"></span> Site Statistics
                  </div>
                </div>
                <div class="widget-body">
                  <div id="lineWithChart">
                    <svg style="height: 340px;"></svg>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                ...
                <div class="widget-body">
                  <div id="section-chart" style="height:340px;"></div>
                </div>
              </div>
            </div>
          </div>
